"""
Django settings for our findhistory project.
...
class Common(Configuration):
    ...
    ROOT_URLCONF = 'findhistory.urls'

    WSGI_APPLICATION = 'findhistory.wsgi.application'
    ...
    TEMPLATE_DIRS = (os.path.join(BASE_DIR, "findhistory/templates"),)
